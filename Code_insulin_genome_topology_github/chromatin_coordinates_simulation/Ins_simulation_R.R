...
save.image("/n/data1/bidmc/medicine/kahn/lab/xyl/Mic5_4_flam/Mic5_4_2_clear_genes/Mic5_4_2_Ins_analysis/Ins_chr.RData")
...
for (i in 1:nrow(mm10_chrom_ordered_sizes_noYM)){
  ...
  flam_tmp = flamingo_main(
    hic_data='/n/data1/bidmc/medicine/kahn/lab/xyl/Mic5_4_flam/no_chr_FLAMINGO_hic_2nd/merge_nochr_Ins_MicroC_intra.hic',
    file_format='hic',
    domain_res=1e6,
    frag_res=5000,
  ...
  flam_list_Ins[[chr_name_mm10]] <- flam_tmp
  
  #Generate output path
  opt_path <- paste0("/n/data1/bidmc/medicine/kahn/lab/xyl/Mic5_4_flam/Mic5_4_2_clear_genes/Mic5_4_2_Ins_analysis/Ins_",chr_name_mm10,".vtk")
  print(opt_path)
...
save.image("/n/data1/bidmc/medicine/kahn/lab/xyl/Mic5_4_flam/Mic5_4_2_clear_genes/Mic5_4_2_Ins_analysis/Ins_flam_output.RData")
